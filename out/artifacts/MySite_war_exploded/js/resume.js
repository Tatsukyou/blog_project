...
const trs4 = '\n\/* 似乎有点单调，那么就让语法高亮吧 *\/';
const lightheight = '\n .token.comment {\n  color:#857F6B;\n }\n .token.property {\n  color:#64D5EA;\n }\n .token.selector{\n  color:#690;\n }\n ';
const trs5 = '\/*接下来，我需要准备一下简历，先将刚才写的样式踢到一边儿去*\/';
...
const str = introduce.concat(trs1).concat(sty1).concat(trs2).concat(sty2).concat(trs3).concat(sty3).concat(trs4).concat(lightheight).concat(trs5).concat(scrollRight);
/*常规定义区*/
...
/*源码版控制区*/
const controller = setInterval(put, 10);
...
function put() {
    ...
    if (n >= 672 && n <= 929) {
        ...
        if (document.getElementById('drawBoard')) {
            ...
            drawBoard = document.createElement('pre');
